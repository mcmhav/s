...
globalkeys = awful.util.table.join(
    ...
    -- awful.key({ }, "F12", function () volume("up", volumewidget) end),
    -- awful.key({ }, "F11", function () volume("down", volumewidget) end),
    -- awful.key({ }, "F10", function () volume("mute", volumewidget) end),

    -- awful.key({ }, "F9", function ()
    --   awful.util.spawn("XF86AudioNext", false) end),
