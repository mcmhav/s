...
let s:black      = g:cake#palette.black
...
call s:h("NormalMode", s:black, g:cake#palette.aqua)
call s:h("InsertMode", s:black, g:cake#palette.pink)
call s:h("ReplaceMode", s:black, g:cake#palette.aqua)
call s:h("VisualMode", s:black, g:cake#palette.yellow)
call s:h("CommandMode", s:black, g:cake#palette.green)
call s:h("LinePosition", s:black, g:cake#palette.aqua)
