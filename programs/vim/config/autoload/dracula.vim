...
"
let g:cake#palette           = {}
let g:cake#palette.aqua      = ['#66d9ef', 117]
let g:cake#palette.pink      = ['#F92772',  84]
let g:cake#palette.yellow    = ['#E6DB74', 215]
let g:cake#palette.green     = ['#3fe069', 212]
let g:cake#palette.black     = ['#272822', 233]
